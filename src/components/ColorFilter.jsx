                ...
                <Accordion.Collapse eventKey="0">
                    <Card.Body bsPrefix="filter-tab__body">
                        {colorsArray.map((item, idx) => {
                            return (
                                <ColorFilterItem chooseColorHEXByName={chooseColorHEXByName} item={item} key={idx} triggerFiltering={triggerFiltering}/>
    ...
    return (
        <div className="filter-tab__params" onClick={() => {toggleCheck(!check); triggerFiltering(item[0])}}>
            ...
            <div className="filter-tab__right-param">
                <div className="filter-tab__param-color" style={{background: `${chooseColorHEXByName(item[0])}`,
                                                        }}></div>
